                ...
                <b-card class="card-item-selected">
                        ...
                        <div class="row">
                             <div class="col-xs-6 mr-2">
                              ...
                              <div class="col-xs-6 ml-4">
                                ...
                                <a v-if="compareEvent1.source != null" class="card-text-selected" :href="compareEvent1.source">{{compareEvent1.source}}</a>
                                <p v-if="compareEvent1.source == null" class="card-text-selected" >No available website link</p>
                              </div>
                    ...
                    <div class="row item-row ml-1">
                        ...
                        <div style="overflow-y: scroll; height:232px;" class="row item-row">
                            <div class="col-md-4 mb-3 mt-3" v-for="assignTech in event1assignTechs" :key="assignTech.id">
            ...
            <div class="col-md-6 mb-3 mt-3">
                <b-card class="card-item-selected">
                        ...
                        <div class="row">
                             <div class="col-xs-6 mr-2">
                              ...
                              <div class="col-xs-6 ml-4">
                                ...
                                <a v-if="compareEvent2.source != null" class="card-text-selected" :href="compareEvent2.source">{{compareEvent2.source}}</a>
                                <p v-if="compareEvent2.source == null" class="card-text-selected" >No available website link</p>
                              </div>
                              <div class="col-xs-6 ml-5 pl-4">
                                  <p class="card-title-sub" >Additional information</p>
                                  <b-card class="card-item-small">
                    ...
                    <div class="row item-row ml-1">
                        ...
                        <div style="overflow-y: scroll; height:232px;" class="row item-row">
                            <div class="col-md-4 mb-3 mt-3" v-for="assignTech in event2assignTechs" :key="assignTech.id">
                                <b-card class="card-item-compare">
                                    <img class="card-img-compare" src="/static/img/icons/apple-touch-icon-180x180.png" alt="card image collar">
                                    <p class="card-title-compare">{{assignTech.name}}</p>
                                </b-card>
