<template>
  <div class="test">
    <div>
        ...
        <div v-cloak v-bind:selectedTechnology="selectedTechnology" v-bind:modal="false" v-bind:compareTech1="compareTech1" v-bind:compareTech2="compareTech2" :is="currentComponent"></div>
        ...
        <div v-if="currentComponent == null && !loading">
            <hr>
