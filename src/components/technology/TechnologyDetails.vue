                        ...
                        <div class="row">
                             <div class="col-xs-6 mr-2">
                              ...
                              <div class="col-xs-6 ml-4">
                                <p class="card-title-selected" href="selectedTechnology.source">{{selectedTechnology.name}} <span class="card-purpose-selected">{{purpose.text}}</span></p>
                                ...
                                <a v-if="selectedTechnology.source != null" class="card-text-selected" :href="selectedTechnology.source">{{selectedTechnology.source}}</a>
                                <p v-if="selectedTechnology.source == null" class="card-text-selected" >No available website link</p>
                              </div>
                        </div>
...
export default {
  ...
  methods: {
    ...
    async getPurpose(){
        this.purpose = await api.getSingleREST("purposes", this.selectedTechnology.purpose_id)
    },
    async getEvents (){
        this.assignEvents = []
